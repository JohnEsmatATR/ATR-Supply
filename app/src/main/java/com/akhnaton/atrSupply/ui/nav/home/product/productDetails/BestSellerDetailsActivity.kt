...
import com.akhnaton.atrSupply.data.statuesValue.nav.home.productDetails.ProductDetailsIntent
import com.akhnaton.atrSupply.data.statuesValue.nav.home.productDetails.ProductDetailsStatus
import com.akhnaton.atrSupply.databinding.ActivityBestSallerDetailsBinding
...
import com.akhnaton.atrSupply.ui.nav.home.product.BestSellerActivity
import com.akhnaton.atrSupply.ui.nav.home.reviews.ReviewActivity
...
class BestSellerDetailsActivity : BaseActivity() {
    ...
    private fun addProductToCart() {
        ...
        if (valiablity == "In Stock"){
            lifecycleScope.launch {
                addCartViewModel.addToCartIntent.send(AddToCartIntent.AddProductToCart(product.ID, quantity,"Cosmetics"))
            }
        }else {
